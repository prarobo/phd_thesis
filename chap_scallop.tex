...
\begin{figure}
      ...
      \includegraphics[width=0.45\textwidth]{scallopred}
      \caption{\cite{prasanna_aslo} (a) Seabed image with scallops shown in red circles}
\end{figure} 
...
\subfigure[]{
      ...
      \includegraphics[width=0.15\textwidth]{dcrescent_scallop}}
\subfigure[]{
      \label{subfig:bcrescent_scallop}
      \includegraphics[width=0.15\textwidth]{bcrescent_scallop}}
% \subfigure[]{
%       \label{subfig:dark_scallop}
%       \includegraphics[width=0.15\textwidth]{dark_scallop.png}}     
\subfigure[]{
      \label{subfig:thresh_scallop}
      \raisebox{-2pt}{\includegraphics[width=0.17\textwidth]{thresh}}}
\subfigure[]{
      \label{subfig:edge_scallop}
      \raisebox{-2pt}{\includegraphics[width=0.17\textwidth]{edge}}}    
...
\centering
\subfigure[]{
      \includegraphics[width=0.6\textwidth,natwidth=1052,natheight=428]{auv_schematics}}
\subfigure[]{
      \includegraphics[width=0.6\textwidth,natwidth=690,natheight=518]{auv_image}}     
%\hfill
...
\caption{List of missions and number of images collected \label{tab:mission_list}}
\centering
...
\end{tabular}}
 ...
 \end{threeparttable}
%\end{center}
%\footnote{LI-Long island, NYB-New York Bight, ET-Elephant trunk}                                                      
\end{table}
...
% \vskip +6pt
\centering
\includegraphics[width=0.45\textwidth,natwidth=800,natheight=600]{fixation_example.pdf}
...
\begin{figure}
\centering
\includegraphics[width=0.50\textwidth,natwidth=800,natheight=600]{windowlength.pdf}
...
\subfigure[]{
      ...
      \includegraphics[width=0.17\textwidth,natwidth=842,natheight=844]{fixationwindow.pdf}}
\subfigure[]{
      \label{subfig:edgeimg}
      \includegraphics[width=0.17\textwidth,natwidth=837,natheight=839]{edgeimg.pdf}}
\subfigure[]{
      \label{subfig:graphimg}
      \includegraphics[width=0.17\textwidth,natwidth=1055,natheight=842]{graphimg.pdf}}    
\subfigure[]{
      \label{subfig:regboundry}
      \includegraphics[width=0.17\textwidth,natwidth=834,natheight=837]{regboundry.pdf}}
\subfigure[]{
      \label{subfig:regcircle}
      \includegraphics[width=0.17\textwidth,natwidth=810,natheight=813]{regcircle.pdf}}         
...
\subfigure[]{
      ...
      \includegraphics[width=0.45\textwidth]{mean_scallop_quadrants.eps}}
\subfigure[]{
      \label{subfig:stddev_quadrant}
      \includegraphics[width=0.45\textwidth]{stddev_scallop_quadrants.eps}}         
...
\subfigure[]{
      ...
      \includegraphics[width=0.3\textwidth]{curr_scallop_mean.eps}}
\subfigure[]{
      \label{subfig:stddev_scallop}
      \includegraphics[width=0.3\textwidth]{curr_scallop_stddev.eps}}
\subfigure[]{
      \label{subfig:mask_scallop}
      \includegraphics[width=0.3\textwidth]{mask_centered.eps}}         
...
\begin{figure}
\centering
\includegraphics[width=0.45\textwidth]{mask_offset.eps}
...
\subfigure[]{
      ...
      \includegraphics[width=0.47\textwidth]{precision_recall.eps}}
\subfigure[]{
      \label{subfig:template_hist}
      \includegraphics[width=0.47\textwidth]{template_thresh_hist.eps}}         
...
Histogram of template match of segmented scallop objects. \label{detection-curves}}
\end{figure*}
%========================================================================================
...
\subfigure[]{
      ...
      \includegraphics[width=0.45\textwidth]{layer4_precision_recall.eps}}
\subfigure[]{
      \label{subfig:hog_precision_recall}
      \includegraphics[width=0.45\textwidth]{layer4_hog_precision_recall.eps}}       
...
\begin{table*}
\caption{Comparison of tested false positive filter layer methods\label{tab:false_positives}}
\begin{center}
\begin{tabular}{lllll}
\toprule[1pt]
	&\multicolumn{2}{c}{\gls{hog}}	&\multicolumn{2}{c}{\gls{wctm}}\\
	&Dataset 1	&Dataset 2	&Dataset 1	&Dataset 2\\ [2pt]\cline{1-5}\\[-5pt]
True positives from Classification Layer	&183		&1\,759		&183		&1759\\
False positives from Classification Layer	&7\,970		&52\,456		&7\,970		&52\,456\\
True positives after Layer IV 			&179		&1\,689		&176		&1\,685\\
False positives after Layer IV 			&7\,752		&51\,329		&2\,924		&16\,407\\
Decrease in true positives after Layer IV	&4 (2.2\%)	&70 (4\%)	&7 (3.8\%)	&74(4.2\%)\\
Decrease in false positives after Layer IV	&218 (2.7\%)	&1\,127 (2.1\%)	&5\,046 (63.3\%)	&36\,049 (68.7\%)\\ \bottomrule
                               \end{tabular}
                               \end{center}
                               \end{table*}      
%
...
\subfigure[]{
      ...
      \includegraphics[height=0.24\textwidth,natwidth=1280,natheight=1014]{77616.jpg}}
\subfigure[]{
      %\vskip +10pt
      \label{subfig:dawkins_crop}
      \includegraphics[width=0.25\textwidth,natwidth=105,natheight=100]{dawkins_crop_resize.png}}
      \hskip 15pt
\subfigure[]{      
      \label{subfig:dawkins_hist}
      \includegraphics[width=0.33\textwidth]{dawkins_hist_sat.eps}}
\end{minipage} 
...
\subfigure[]{
      ...
      \includegraphics[height=0.24\textwidth]{60.eps}} 
\subfigure[]{
      \label{subfig:typical_crop}
      \includegraphics[width=0.235\textwidth]{our_crop_resize.eps}}
      \hskip 15pt
\subfigure[]{      
      \label{subfig:typical_hist}
      \includegraphics[width=0.35\textwidth]{our_hist_sat.eps}}
\end{minipage}
