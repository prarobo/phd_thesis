...
\begin{figure}
\vskip -20pt
\subfigure[Backscatter image of sea-floor from Gavia AUV]{
      \label{subfig:subwayorig}
      \includegraphics[width=0.9\textwidth]{subwayorig.eps}
      }
\subfigure[Image segmentation using basic morphological operations and edge detection]{
      \label{subfig:subwaysegment}
      \includegraphics[width=0.9\textwidth]{subwaysegment.eps}
      }    
\caption{}
\end{figure}
...
\subfigure[]{
      ...
      \includegraphics[width=0.3\textwidth]{eigenrect}
      }
\subfigure[]{
      \label{subfig:eigendistances}
      \includegraphics[width=0.4\textwidth,height=4cm]{subway_dot_prod}
}
...
\subfigure[]{
      ...
      \includegraphics[width=0.45\textwidth]{best1}
      }
\subfigure[]{
      \label{subfig:subwaybest2}
      \includegraphics[width=0.45\textwidth]{best2}
      }
\subfigure[]{
      \label{subfig:subwayworst}
      \includegraphics[width=0.45\textwidth]{worst1}
      }
