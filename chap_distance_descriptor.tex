...
The series of images captured between heights $d_{max}$ and $d_{min}$, with a step-change of distance $d_{int}$ between subsequent images results in $t$ images per specimen, where
\begin{align}
...
\end{align}
Since there are $t$ different height-tags along with 3 different color components, each object class $c$ is represented by a sequence of $36\, (13 \times 3)$ histogram signatures, which will be collectively referred to as $\bar{\mathcal{H}}^{c}$.
